package com.ahirajustice.api.location.service.common.filters;

import com.ahirajustice.api.location.service.common.constants.SecurityConstants;
import com.ahirajustice.api.location.service.common.utils.UriUtils;
...
public class RequestResponseLoggingFilter extends GenericFilterBean{
    ...
    private boolean excludeFromRequestResponseLogger(String requestUri, String requestMethod) {
        for (String uriMethodCsv : SecurityConstants.EXCLUDE_FROM_REQUEST_RESPONSE_LOGGER) {
            if (!UriUtils.uriMatch(requestUri, requestMethod, uriMethodCsv))
                continue;
